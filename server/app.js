...
邮箱: ${req.body.address}
    ...
    <a href="https://www.xxx.cn" style="text-decoration: none; background: lightgreen;color: #fff; height: 2rem; line-height: 2rem; padding: 0 1rem; display: inline-block; border-radius: 0.2rem;">回到文章</a>
    </div>
    `
    mail.send('595123108@qq.com', '您的文章有一条新留言', content, res)
